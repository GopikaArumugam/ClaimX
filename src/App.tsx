...
import { Claim, ClaimStatus, AgentId } from './types/claims';
...
import { ClaimsTable } from './components/command-center/ClaimsTable';
import { LiveActivityFeed } from './components/command-center/LiveActivityFeed';
import { LiveOrchestratorView } from './components/live-orchestration/LiveOrchestratorView';
import { NewClaimWizard } from './components/new-claim/NewClaimWizard';
import { ClaimDetailsView } from './components/claim-details/ClaimDetailsView';
import { HumanReviewView } from './components/human-review/HumanReviewView';
import { PaymentSettlementView } from './components/settlement/PaymentSettlementView';
import { CustomerTrackingView } from './components/customer-portal/CustomerTrackingView';
              ...
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4">
                  <LiveActivityFeed
                    ...
                    onSelectClaim={(id) => handleOpenClaimDetails(id)}
                  />
                </div>
              </div>
            </div>
